...
class GameRoom(models.Model):
    ...
    owner = models.ForeignKey(User, on_delete=models.CASCADE, related_name='owner_gameroom')
...
class GameJoin(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='selected_by_user')
...
class SinglemodeSession(BaseSession):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='user_singlemode_session')
...
class MultimodeSession(BaseSession):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='user_multimode_session')
